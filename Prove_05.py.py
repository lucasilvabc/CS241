...
class Point:
# This class set the values for x and y
    def __init__(self):
        self.x = 0.0
        self.y = 0.0
    
class Velocity:
# This class set the values for dx and dy
    def __init__(self):
        self.dx = 0.0
        self.dy = 0.0

class Ball:
# This class defines the format, movement for a ball
    def __init__(self):
        
        self.center = Point()
        self.center.x = 25
        self.center.y = random.randint(10, 250)
        self.velocity = Velocity()
        self.velocity.dx = random.randint(1, 2)
...
# This function tells the ball how to move
    def advance(self):
        self.center.x += self.velocity.dx
        self.center.y += self.velocity.dy
# This function set how the ball bounce horizontally
    def bounce_horizontal(self):
        self.velocity.dx *= -1
# This function set how the ball bounce vertically
    def bounce_vertical(self):
        self.velocity.dy *= -1
# This function helps restart the game
    def restart(self):
        self.__init__()


class Paddle:
# This class defines the format, movement for the paddle
    def __init__(self):
...
# This function draws the paddle
    ...
    def move_up(self):
# This function define how the paddle moves up      
        if self.center.y < SCREEN_HEIGHT - 25:
            self.center.y += MOVE_AMOUNT
        else:
            pass
# This function define how the paddle moves down      
    def move_down(self):
...
class Pong(arcade.Window):
    ...
    def draw_score(self):
        ...
        arcade.draw_text(score_text, start_x=start_x, start_y=start_y, font_size=12, color=arcade.color.BLUE)
