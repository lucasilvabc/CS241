...
def get_part1_list():
    ...
    """
    numbers = [0 - 99] # TODO: Change this line to be a list comprehension
...
def get_part3_list():
    ...
    new_words = ["knowledge", "water", "white", "covenants", "phone", "send", "restrictions"] # TODO: Change this line to be a list comprehension
